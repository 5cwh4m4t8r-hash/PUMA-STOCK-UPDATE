...
def _daily():
    ...
    rows[-6:-1] = [
        _d("20260916", 100, 101, 99, 100, 1000),
        _d("20260917", 100, 102, 99, 101, 1000),
        _d("20260918", 101, 103, 100, 102, 1000),
        _d("20260921", 102, 104, 101, 103, 1000),
        _d("20260922", 103, 104, 102, 103, 1000),
    ]
...
def _minute(body_break=True):
    rows = [
        _d("20260923090000", 106, 107, 105.8, 106.5, 100),
        _d("20260923090500", 106.5, 109, 106.4, 108.8, 150),
        _d("20260923091000", 108.8, 113, 108.7, 112.5, 260),  # 영1
        _d("20260923091500", 112.0, 112.3, 110.0, 111.6, 120), # 차
    ]
    if body_break:
        rows.append(_d("20260923092000", 112.2, 114.5, 112.0, 114.0, 240))
    return rows
...
def test_tail_only_break_is_rejected():
    rows = _minute(False)
    rows.append(_d("20260923092000", 112.0, 114.5, 111.8, 112.8, 240))
...
def test_pullback_cannot_touch_basis_open():
    rows = _minute(False)
    rows[-1] = _d("20260923091500", 112.0, 112.2, 106.0, 110.0, 100)
