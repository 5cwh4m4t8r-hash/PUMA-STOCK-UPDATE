...
class MainWindow(QMainWindow):
    ...
    def _record_focus_latency(self, stage):
        if stage not in self.focus_latency_ms and self._click_started:
            self.focus_latency_ms[stage] = round((time.perf_counter() - self._click_started) * 1000, 2)
